...
class FakeGroupService(supabaseService: SupabaseService) : GroupService(supabaseService) {
    ...
    override suspend fun isUserMemberOfGroup(userId: String, groupId: String, requestContext: com.viaduct.config.RequestContext): Boolean {
...
class GroupMembershipPolicyCheckTest : FunSpec({
    ...
    lateinit var requestContextWrapper: com.viaduct.config.RequestContext
    ...
    beforeEach {
        ...
        requestContextWrapper = com.viaduct.config.RequestContext(
