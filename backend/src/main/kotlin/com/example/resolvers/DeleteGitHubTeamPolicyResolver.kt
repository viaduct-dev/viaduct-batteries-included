...
class DeleteGitHubTeamPolicyResolver(
    ...
    override suspend fun resolve(ctx: Context): Boolean {
        ...
        val policy = ctx.authenticatedClient.getGitHubTeamPolicyById(policyId)
        val result = viaAccessService.deleteGitHubTeamPolicy(ctx.authenticatedClient, policyId)
