...
class DeleteAsanaPortfolioPolicyResolver(
    ...
    override suspend fun resolve(ctx: Context): Boolean {
        ...
        val policy = ctx.authenticatedClient.getAsanaPortfolioPolicyById(policyId)
        val result = viaAccessService.deleteAsanaPortfolioPolicy(ctx.authenticatedClient, policyId)
